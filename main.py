...
df = pd.read_csv('Motor_Vehicle_Collisions_NY.csv', dtype={'ZIP CODE': str})
...
# Plotting a line plot over time for the total persons affected in accidents
...
print("6. Hour of the Day with Most Accidents:", most_accidents_hour)
